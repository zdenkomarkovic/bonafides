    ...
    >
      <div className="container mx-auto px-2 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Kontakt Informacije */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Kontakt</h3>
            <div className="space-y-3">
              <Link href="tel:+381638226026" className="flex items-center gap-2 hover:text-primary transition-colors">
          ...
          {/* Brzi Linkovi */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Brzi linkovi</h3>
            <div className="space-y-2">
              <Link href="/" className="block hover:text-primary transition-colors">
                Početna
              </Link>
              <Link href="/nekretnine" className="block hover:text-primary transition-colors">
                Nekretnine
              </Link>
              <Link href="/o-nama" className="block hover:text-primary transition-colors">
                O Nama
              </Link>
          ...
          {/* Društvene Mreže */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Pratite nas</h3>
        ...
        <div className="flex flex-col md:flex-row justify-center text-center gap-2 md:gap-10 border-t-[1px] border-primary/20 mt-10 pt-5">
          <p>
            &copy; {new Date().getFullYear()} Bona Fides Nekretnine Nova. Sva prava zadržana.
          </p>
